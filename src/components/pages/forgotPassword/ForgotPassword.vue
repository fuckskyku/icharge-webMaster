    ...
    <div class="child">
      <div class="step">
        <el-steps :active="active" align-center finish-status="success">
          ...
          <el-step title="成功找回密码"></el-step>
        </el-steps>
      </div>
      <!-- 步骤1 -->
      <div class="container" v-if="active == 0">
        <div class="head">手机号验证</div>
        <div class="section">
          <el-form
            :model="registerForm"
            ref="registerForm"
      ...
      <div class="container" v-if="active == 3">
        <div class="head">恭喜您成功找回密码！</div>
        <div class="section sec">
          <div class="success_icon"><img src="/static/img/login_register_findPassword/img_success.png" alt=""></div>
          <div class="desc">
            <p>您已成功找回密码，请牢记您的新密码。</p>
          </div>
          <el-button type="success" class="submit quality" @click="skip('Login')">立即登录</el-button>
        </div>
      </div>
      <!--  -->
    </div>
...
import { isregistermobile, getPhoneCode, firstoperate, forgetpassword } from "@/api/api";
